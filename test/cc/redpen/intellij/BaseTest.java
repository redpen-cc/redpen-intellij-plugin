...
public abstract class BaseTest {
  protected Configuration configWithValidators(List<ValidatorConfiguration> validatorConfigs) {
  ...
  protected Configuration configWithSymbols(List<Symbol> symbols) {
    Configuration.ConfigurationBuilder builder = new Configuration.ConfigurationBuilder();
